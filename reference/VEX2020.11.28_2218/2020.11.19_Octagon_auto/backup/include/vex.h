...
vex::motor lf1 = vex::motor(vex::PORT7, false);   //左前轮1
vex::motor lf2 = vex::motor(vex::PORT8, false);   //左前轮2
vex::motor lb1 = vex::motor(vex::PORT9, false);   //左后轮1
vex::motor lb2 = vex::motor(vex::PORT10, false);  //左后轮2

vex::motor rf1 = vex::motor(vex::PORT17, true);   //右前轮1
vex::motor rf2 = vex::motor(vex::PORT18, true);   //右前轮1
vex::motor rb1 = vex::motor(vex::PORT19, true);   //右后轮1
vex::motor rb2 = vex::motor(vex::PORT20, true);   //右后轮1

vex::motor lz = vex::motor(vex::PORT1, true);     //左爪
vex::motor rz = vex::motor(vex::PORT2, false);    //右爪
//zffzzf
...
vex::motor bu = vex::motor(vex::PORT11, true);   //后上方电机
vex::motor bd = vex::motor(vex::PORT12, false);  //后下方电机
